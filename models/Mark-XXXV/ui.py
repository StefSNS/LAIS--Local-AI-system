...
class JarvisUI:
    ...
    def _save_api_keys(self):
        ...
        # Save to .env file (primary)
        env_path = BASE_DIR / ".env"
        env_content = f"# API Keys - DO NOT COMMIT THIS FILE\nGEMINI_API_KEY={gemini}\n"
        ...
        with open(API_FILE, "w", encoding="utf-8") as f:
            json.dump({"gemini_api_key": "ENV:GEMINI_API_KEY", "note": "API keys are now loaded from .env file"}, f, indent=4)
