    ...
    def _try_llmlingua(self, text: str) -> Optional[Dict]:
        try:
            if self._llmlingua is None:
                ...
                self._llmlingua = PromptCompressor(use_llmlingua2=True, llmlingua2_config={"model_name": "microsoft/llmlingua-2-bert-base-multilingual-cased-meetingbank"})
            result = self._llmlingua.compress_prompt(text, rate=0.7)
