...
_TR_LOCAL_MODELS = str(_TR_BASE / "models")
_TR_LOCALCLAW = r"%USERPROFILE%\Desktop\AI projects\Projects\LocalClaw\models"
_TR_MODELS_DIR = _TR_LOCALCLAW if os.path.isdir(_TR_LOCALCLAW) else _TR_LOCAL_MODELS
MODEL_CONFIGS = {
    'smol3': {
        'name': 'smol3',
        'label': 'SmolLM3-3B',
        'path': os.path.join(_TR_MODELS_DIR, 'HuggingFaceTB_SmolLM3-3B-Q4_K_M.gguf'),
        'size_gb': 2.0,
        'best_for': ['reasoning', 'creative_writing', 'general_chat', 'summarization', 'analysis'],
        'context': 4096,
        'port': 8100,
        'n_gpu_layers': 0,
    },
